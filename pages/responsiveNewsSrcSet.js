...
export default () => (
    <div>
        <Head>
            ...
            <link rel="stylesheet" href="static/grid-base.css" />
          ...
          <div className="row row-quartet">
            <div className="col subcategory-featured">
              <article className="story">
                <img src="static/600x300.png" srcset="static/1200x600.png 1.5x" alt="Dummy image"/>
            ...
            <div className="col">
              <article className="story">
                <img src="static/300x150.png" srcset="static/600x300.png 1.5x" alt="Dummy image"/>
